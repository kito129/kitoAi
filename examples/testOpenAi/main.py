...
def submit(promt_text, response_text):
  ...
  response = openai.Completion.create(
    ...
    max_tokens=600,
    top_p=1,
    #Frequency Penalty: The frequency_penalty parameter helps to control repetitive responses. Increasing the frequency penalty (e.g., setting it to a value greater than 0) discourages the model from repeating the same phrases or words too often. Experiment with different frequency penalty values (e.g., 0.2, 0.5, 1.0) to find the right balance. Consider increasing the value if you notice excessive repetition in the generated text. Presence Penalty: The presence_penalty
